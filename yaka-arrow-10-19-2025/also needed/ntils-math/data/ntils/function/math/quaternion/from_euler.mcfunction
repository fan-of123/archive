...
#
#   Given three euler angles, generate a rotation quaternion.
#   NOTE: If the yaw and pitch of the rotation you are grabbing happens to be the rotation context, use math/quaternion/from_context_roll instead!
#
# INPUT:
#   > Scoreboard:
#       | #math.quaternion.[yaw,pitch,roll] (3)    -> The angles. Scale these by 1000.
#   > Flags:
...
#
# PERFORMANCE: Okay
#   The slowest of the from_* family. Only use this if a better alternative doesn't exist.
...
execute as 00000023-0000-0000-0000-002300000000 at @s positioned .0 0 .0 run function ntils:z/math/quaternion/from_euler/as_marker

function ntils:z/math/quaternion/from_euler/eval