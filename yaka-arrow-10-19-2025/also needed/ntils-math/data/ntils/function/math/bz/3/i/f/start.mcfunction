...
#       | Calling ntils:math/bz/3/i/f/loop will perform one step of the iteration and create usable output.
#
# PERFORMANCE: Okay
...
execute store result storage ntils:out math.bz.3[0] double 0.001 store result score #math.bz.3.x ntils.out run scoreboard players operation #math.bz.3.i.base.x ntils.z.math.bz.3.temp = #math.bz.3.a.x ntils.in
execute store result storage ntils:out math.bz.3[1] double 0.001 store result score #math.bz.3.y ntils.out run scoreboard players operation #math.bz.3.i.base.y ntils.z.math.bz.3.temp = #math.bz.3.a.y ntils.in
execute store result storage ntils:out math.bz.3[2] double 0.001 store result score #math.bz.3.z ntils.out run scoreboard players operation #math.bz.3.i.base.z ntils.z.math.bz.3.temp = #math.bz.3.a.z ntils.in