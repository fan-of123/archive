...
#       | Calling ntils:math/bz/4/i/f/loop will perform one step of the iteration and create usable output.
#
# PERFORMANCE: Okay
...
scoreboard players operation #o ntils.z.math.bz.4.temp /= #math.bz.4.terations ntils.in
scoreboard players operation #o ntils.z.math.bz.4.temp *= #1000 ntils.z.const
execute store result score #math.bz.4.i.jerk.x ntils.z.math.bz.4.temp run scoreboard players operation #o ntils.z.math.bz.4.temp /= #math.bz.4.terations ntils.in
...
scoreboard players operation #o ntils.z.math.bz.4.temp /= #math.bz.4.terations ntils.in
scoreboard players operation #o ntils.z.math.bz.4.temp *= #1000 ntils.z.const
execute store result score #math.bz.4.i.jerk.y ntils.z.math.bz.4.temp run scoreboard players operation #o ntils.z.math.bz.4.temp /= #math.bz.4.terations ntils.in
...
scoreboard players operation #o ntils.z.math.bz.4.temp /= #math.bz.4.terations ntils.in
scoreboard players operation #o ntils.z.math.bz.4.temp *= #1000 ntils.z.const
execute store result score #math.bz.4.i.jerk.z ntils.z.math.bz.4.temp run scoreboard players operation #o ntils.z.math.bz.4.temp /= #math.bz.4.terations ntils.in
...
execute store result storage ntils:out math.bz.4[0] double 0.001 store result score #math.bz.4.x ntils.out run scoreboard players operation #math.bz.4.i.base.x ntils.z.math.bz.4.temp = #math.bz.4.a.x ntils.in
execute store result storage ntils:out math.bz.4[1] double 0.001 store result score #math.bz.4.y ntils.out run scoreboard players operation #math.bz.4.i.base.y ntils.z.math.bz.4.temp = #math.bz.4.a.y ntils.in
execute store result storage ntils:out math.bz.4[2] double 0.001 store result score #math.bz.4.z ntils.out run scoreboard players operation #math.bz.4.i.base.z ntils.z.math.bz.4.temp = #math.bz.4.a.z ntils.in