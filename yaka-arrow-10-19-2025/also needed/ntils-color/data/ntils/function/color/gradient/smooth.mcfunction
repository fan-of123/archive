...
#   Performs easing using the smoothstep function, making this very smooth 
#   at the start and and but steep in the middle. (t=0 is start, t=1000 is end)
#
# INPUT:
#   > Scoreboard:
...
scoreboard players set #t ntils.z.color.temp 1500
scoreboard players operation #t ntils.z.color.temp -= #color.gradient.time ntils.in
scoreboard players operation #t ntils.z.color.temp *= #color.gradient.time ntils.in
scoreboard players operation #t ntils.z.color.temp *= #color.gradient.time ntils.in
scoreboard players operation #t ntils.z.color.temp /= #500000 ntils.z.const
